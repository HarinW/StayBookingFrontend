  ...
  render() {
    ...
    return (
      <>
        ...
        {modalVisible && ( // display modal when modalVisible is true
          <Modal
            title={modalTitle}
            centered={true}
  ...
  render() {
    ...
    return (
      <>
        ...
        {modalVisible && ( // show Modal only when modalVisible is true
          <Modal
            title={name}
            centered={true}
            visible={modalVisible}
          ...
          >
            <Space direction="vertical">
              {/*Space is a container component that can be used to space out its children in a row or column. */}
